...
const Navbar = ({ children }) => {
    ...
    return (
        <div class="drawer drawer-end" data-them={dark ? "dark" : "light"}>
            <input id="my-drawer-3" type="checkbox" class="drawer-toggle" />
            <div class="drawer-content flex flex-col">

                <div class="w-full navbar bg-white lg:px-20 fixed top-0 z-50">
                    { pathname.includes('dashbord') && (<label tabindex="0" for="my-drawer" class="btn btn-ghost btn-circle lg:hidden">
                    ...
                    <div class="flex-none hidden lg:block">
                        <ul class="menu menu-horizontal gap-x-2">
                            ...
                            {admin && (<li><NavLink to='/dashbord' className='rounded-lg'>Dashbord</NavLink></li>)}
